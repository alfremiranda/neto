    ...
    <TooltipProvider>
      <SidebarProvider defaultOpen className="flex-col h-[100dvh] overflow-hidden">
        ...
        <div className="relative flex flex-row flex-1 min-h-0 overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-5 lg:p-6 pb-[calc(62px+env(safe-area-inset-bottom))] sm:pb-5 lg:pb-6 bg-[var(--background)] min-w-0">

...
const meta = { title: 'Cuentas/AccountAvatar', parameters: { layout: 'padded' } } satisfies Meta
export default meta
type Story = StoryObj<typeof meta>

/** All twelve, in hue order — the same order the picker shows and the hash indexes into. */
export const LosDoceColores: Story = {
  render: () => (
...
export const PorTipoYTamano: Story = {
  render: () => (
...
export const Chip: Story = {
  name: 'AccountBadge — el chip con punto',
  render: () => (
    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>

    ...
    <Popover>
      <PopoverTrigger asChild>
        <button
          ...
          className={cn(
            'flex w-full items-center gap-2 h-11 sm:h-9 rounded-lg border border-input bg-[var(--card)] px-4 sm:px-3 text-left whitespace-nowrap transition-colors outline-none select-none focus-visible:border-2 focus-visible:border-foreground disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive',

...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-1.5 rounded-full border border-transparent text-sm font-medium whitespace-nowrap transition-all duration-100 active:scale-95 outline-none select-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        default:   "h-9 px-[14px] gap-2 [&_svg]:size-4",                                     /* Figma LG  36px */
        xs:        "h-6 px-2 text-[11px] gap-1 [&_svg]:size-3",                              /* Figma SM  24px */
        sm:        "h-7 px-[10px] text-[12px] [&_svg]:size-3",                               /* Figma MD  28px */
        lg:        "h-10 px-5 gap-2 [&_svg]:size-4",
        xl:        "h-11 px-4 text-base gap-2 [&_svg]:size-5",                               /* Figma XL  44px */
        icon:      "size-9",                                                                 /* 36px */
